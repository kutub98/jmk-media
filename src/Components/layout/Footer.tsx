...
const Footer = () => {
    return (
        <div className='fixed w-full bottom-0 z-1 bg-black text-white'>
            <footer className="dark:bg-gray-800 dark:text-gray-50">
	<div className="container flex flex-col p-2 mx-auto md:p-8 lg:flex-row divide-gray-400">
		<ul className="self-center py-1 space-y-1 text-center sm:flex sm:space-y-0 sm:justify-around sm:space-x-4 lg:flex-1 lg:justify-start">
			<li>Shop</li>
			<li>About</li>
			<li>Blog</li>
			<li>Pricing</li>
