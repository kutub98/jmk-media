...
const Header = () => {
    return (
        <div className='fixed w-full mt-0 z-10 '>
          <header className="p-4 header justify-center dark:bg-gray-800 dark:text-gray-100">
	<div className="container flex justify-between h-16 mx-auto">
		<ul className="items-stretch hidden space-x-3 lg:flex">
			<li className="flex">
				<Link to={""} className="flex items-center px-4 -mb-1 hover:border-b-2 dark:border-transparent dark:text-violet-400 dark:border-violet-400">Link</Link>
			</li>
			<li className="flex">
				<Link to={""} className="flex items-center px-4 -mb-1 hover:border-b-2 dark:border-transparent">Link</Link>
			</li>
			<li className="flex">
				<Link to={""} className="flex items-center px-4 -mb-1 hover:border-b-2 dark:border-transparent">Link</Link>
			</li>
